...
The challenge prevides the following values
```python
e = 65537
...
d1 = 
d2 = 
```

### Observation

1. `gcd(n1,n2) != 1`
2. `pow(pow(2,e1,n),d1,n) != 2`

### Strategy

Knowing the first observation, we can factor both `n1` and `n2`.
`d1` is not the real private key, so we guess it is ciphertext.
